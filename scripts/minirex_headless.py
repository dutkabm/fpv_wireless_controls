...
def main():
    ...
    serial_port = autodetect_serial_port(baud_rate, serial_port)
    if serial_port is None:
        print("No serial ports available.")
    elif is_autoselect_serial_port(prev_serial):
        print(f"Auto-detected serial port: {serial_port}")
    elif str(prev_serial).strip() != str(serial_port).strip():
        print(f"Configured port {prev_serial!r} missing; using {serial_port!r} instead.")
